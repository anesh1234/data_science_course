...
def main():
    ...
    results = model.train(data= "datasets/d1/data.yaml",  # data (str): Path to dataset configuration file.
                        epochs= 20,                      # epochs (int): Number of training epochs., 
...
# Idiom to ensure that a new process cannot start before the current process has finished its bootstrapping phase
